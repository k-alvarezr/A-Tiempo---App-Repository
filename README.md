...
Se incluye un APK de depuración firmado en `mobile/apk/A-Tiempo-debug.apk`, con `minSdkVersion 27`. La firma y el manifiesto fueron verificados; falta probar su instalación y navegación en un dispositivo o emulador Android real antes de entregar. No se incluyen credenciales, datos de pacientes ni integración real.
